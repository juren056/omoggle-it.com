...
3. Decide whether optional GA4 is legally and operationally appropriate for the served regions. Set `ANALYTICS_ENABLED=true` only after validating the consent wording and GA property retention settings. This code does not pretend to be a Google-certified CMP and no Google ads are used.
