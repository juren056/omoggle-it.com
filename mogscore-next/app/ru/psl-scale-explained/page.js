...
export const metadata = {
  title: 'PSL Scale объяснён: что означает каждая оценка | MogScore',
  description: 'Полная PSL Scale, которую Omoggle использует для ИИ-скоринга. Что означает каждый ранг и где реально оказываются игроки.',
}
    ...
    <>
      ...
      <header style={{padding:'var(--sp-lg) 0 var(--sp-sm)',borderBottom:'1px solid var(--border)'}}>
        <div className="container-sm">
          ...
          <h1 style={{marginTop:'.75rem'}}>PSL Scale объяснён: что означает каждая оценка (1–10)</h1>
        </div>
      </header>
