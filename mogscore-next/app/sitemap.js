export default function sitemap() {
  ...
  // Content pages (static HTML in public/)
  const contentPages = [
  ...
  const i18nPages = langs.flatMap(lang => [
    ...
    { url: `${baseUrl}/${lang}/tools`, lastModified: today, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${baseUrl}/${lang}/what-is-omoggle`, lastModified: today, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/${lang}/how-to-win-omoggle`, lastModified: today, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/${lang}/psl-scale-explained`, lastModified: today, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/${lang}/looksmaxxing-guide`, lastModified: today, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/${lang}/xqc-omoggle`, lastModified: today, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/${lang}/canthal-tilt-guide`, lastModified: today, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/${lang}/omoggle-tier-list-2026`, lastModified: today, changeFrequency: 'monthly', priority: 0.7 },
  ])
