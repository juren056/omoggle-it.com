  ...
  return (
    <>
      ...
      <header className="seo-page-header"><div className="container-sm">
        ...
        <p>Upload a photo to get a playful mog rating with clear labels for eye area, jawline, harmony and facial structure.</p>
      </div></header>
      <main>
        ...
        <section className="section section-alt"><article className="content-section container-sm">
          ...
          <p>This page reuses the same analyzer as our <Link href="/tools">AI Face Analyzer</Link>. It turns six underlying metrics into an overall number plus plain-language descriptions such as Strong, Above Average, Balanced or Developing.</p>
